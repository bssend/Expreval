...
public class GtOperator extends CompareOperator implements ICompareOperator {
    @Override
    public BooleanNode compute(StringNode left, StringNode right) {
        throw new OperatorNotSupportedException(
                "Gt operator is not supported string type.");
    }
    ...
    public BooleanNode compute(BooleanNode left, BooleanNode right) {
        throw new OperatorNotSupportedException(
                "Gt operator is not supported boolean type.");
    }
//    @Override
//    public BooleanNode compute(StringNode left, StringNode right) {
//        throw new OperatorNotSupportedException(
