...
public class DivOperator extends ArithmeticOperator implements IArithmeticOperator {

    @Override
    public StringNode compute(StringNode left, StringNode right) {
        throw new OperatorNotSupportedException(
                "Div operator is not supported string type.");
    }
    ...
    public BooleanNode compute(BooleanNode left, BooleanNode right) {
        throw new OperatorNotSupportedException(
                "Div operator is not supported boolean type.");
    }
//
//    @Override
//    public StringNode compute(StringNode left, StringNode right) {
