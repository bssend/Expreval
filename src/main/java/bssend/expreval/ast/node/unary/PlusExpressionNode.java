...
public class PlusExpressionNode extends UnaryExpressionNode implements IUnaryExpressionNode {

    public PlusExpressionNode(IExpressionNode expression, Token token) {
