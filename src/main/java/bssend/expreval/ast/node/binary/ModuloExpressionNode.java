...
public class ModuloExpressionNode extends BinaryExpressionNode implements IBinaryExpressionNode {

    public ModuloExpressionNode(IExpressionNode left, IExpressionNode right, Token token) {
