...
public class LessThanOrEqualExpressionNode extends BinaryExpressionNode implements IBinaryExpressionNode {

    public LessThanOrEqualExpressionNode(IExpressionNode left, IExpressionNode right, Token token) {
