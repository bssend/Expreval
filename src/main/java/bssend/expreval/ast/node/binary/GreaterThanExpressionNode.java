...
public class GreaterThanExpressionNode extends BinaryExpressionNode implements IBinaryExpressionNode {

    public GreaterThanExpressionNode(IExpressionNode left, IExpressionNode right, Token token) {
