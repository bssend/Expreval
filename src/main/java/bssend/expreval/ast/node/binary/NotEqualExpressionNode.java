...
public class NotEqualExpressionNode extends BinaryExpressionNode implements IBinaryExpressionNode {

    public NotEqualExpressionNode(IExpressionNode left, IExpressionNode right, Token token) {
