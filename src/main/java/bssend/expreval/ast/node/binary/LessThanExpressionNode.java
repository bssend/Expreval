...
public class LessThanExpressionNode extends BinaryExpressionNode implements IBinaryExpressionNode {

    public LessThanExpressionNode(IExpressionNode left, IExpressionNode right, Token token) {
