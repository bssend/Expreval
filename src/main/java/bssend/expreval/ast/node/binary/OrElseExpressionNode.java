...
public class OrElseExpressionNode extends BinaryExpressionNode implements IBinaryExpressionNode {

    public OrElseExpressionNode(IExpressionNode left, IExpressionNode right, Token token) {
