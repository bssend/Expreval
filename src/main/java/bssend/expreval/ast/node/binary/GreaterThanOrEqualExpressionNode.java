...
public class GreaterThanOrEqualExpressionNode extends BinaryExpressionNode implements IBinaryExpressionNode {

    public GreaterThanOrEqualExpressionNode(IExpressionNode left, IExpressionNode right, Token token) {
